...
class DoctorExperienceDataTable extends DataTable
{
    ...
    public function dataTable($query,Request $request)
    {
        ...
        ->rawColumns([
            ...
            && !empty($request->input('search')['value'])) {
                ...
                $query->whereTranslationLike("title", "%" . $searchValue . "%")->orWhereTranslationLike("text", "%" . $searchValue . "%");
            }
        })->orderColumn('title', function ($query, $order) {
            $query->orderByTranslation('title', $order);
        })->orderColumn('text', function ($query, $order) {
            $query->orderByTranslation('text', $order);
        });
    }
    /**
     ...
     */
    public function query(DoctorExperience $model): QueryBuilder
    {
        return $model->newQuery()->where("doctor_id",$this->id);
    }

...
class WebsiteReasonDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\WebsiteReason $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(WebsiteReason $model): QueryBuilder
    {
    ...
    {
        return 'WebsiteReason_' . date('YmdHis');
    }
}

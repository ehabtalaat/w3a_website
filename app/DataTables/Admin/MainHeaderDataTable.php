...
class MainHeaderDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\MainHeader $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(MainHeader $model): QueryBuilder
    {
    ...
    {
        return 'MainHeader_' . date('YmdHis');
    }
}

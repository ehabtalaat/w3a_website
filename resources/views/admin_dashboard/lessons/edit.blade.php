  ...
  <div class="card card-custom gutter-b">
    ...
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label"> {{__('messages.edit lesson')}}</h3>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-6 mx-auto">
            <div class="uploadOuter">
              ...
              @if($lesson->image)
              <img src="{{$lesson->image->image_link}}">
              @endif
              </div>
          </div>
        <div class="col-md-6 col-12 mx-auto text-center mb-5 set-img mx-auto">
                    <video width="200" height="200" controls >
              <source src="{{ $lesson->video_link ?? ''}}" id="video_here">
...
@enderror" required value="{{ $lesson->translate($localeCode)->title}}" name="title-{{ $localeCode }}">
          ...
          <div class="col-md-6 col-sm-12">
            <div class="form-group">
              ...
              <textarea class="form-control   @error('text-' . $localeCode) is-invalid 
                          @enderror" required name="text-{{ $localeCode }}" rows="6">{{$lesson->translate($localeCode)->text ?? ''}}
              </textarea>
...
success:function(data)
{
  ...
  if(data.status == false)
  {
    ...
    location.href =`../../lessons/${data.course_id}`;
  }
}
});
      </script>

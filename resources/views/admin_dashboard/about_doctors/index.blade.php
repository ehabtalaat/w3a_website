...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.add main_header')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('main_headers.update')}}" enctype="multipart/form-data">
        @method('PUT')
    @csrf
    <div class="row">
        ...
        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          @enderror" 
                          required value="{{ $main_header->translate($localeCode)->title ?? ''}}"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        name="text-{{ $localeCode }}"
                         placeholder="{{ __('messages.text_'.$localeCode) }}" rows="7" required>{{ $main_header->translate($localeCode)->text ?? ""}}</textarea>

<a href="{{route('experiences.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                         ...
                         {{-- @if(auth()->id() != $id) --}}
                            <div style="cursor:pointer;" onclick="deleteexperiences({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

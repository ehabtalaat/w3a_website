...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit experience')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('doctor_experiences.update',$experience->id)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$experience->translate($localeCode)->title ?? ""}}"
                           required>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}" rows="7"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" required>{{$experience->translate($localeCode)->text ?? ""}}
                          </textarea>

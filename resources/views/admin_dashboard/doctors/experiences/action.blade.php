<a href="{{route('doctor_experiences.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                         ...
                         {{-- @if(auth()->id() != $id) --}}
                            <div style="cursor:pointer;" onclick="deletedoctor_experiences({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deletedoctor_experiences(id){

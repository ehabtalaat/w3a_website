...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.add doctor')}}</h3>
		</div>
	</div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            name="mini_description-{{ $localeCode }}" rows="3"
                             placeholder="{{ __('messages.mini_description_'.$localeCode) }}" required></textarea>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        name="description-{{ $localeCode }}" rows="7"
                         placeholder="{{ __('messages.description_'.$localeCode) }}" required></textarea>

...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit certificate')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('doctor_certificates.update',$certificate->id)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <img src="{{$certificate->image->image_link}}">
        @endif
        </div>
              </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$certificate->translate($localeCode)->title ?? ""}}"
                           required>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" rows="7" required>{{$certificate->translate($localeCode)->text ?? ""}}
                          </textarea>

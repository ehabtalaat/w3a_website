...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit website_reason')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('website_reasons.update',$website_reason->id)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        @if($website_reason->image)
        <img src="{{$website_reason->image->image_link}}">
        @endif
        </div>
              </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$website_reason->translate($localeCode)->title ?? ""}}"
                           required>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}" rows="7"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" required>{{$website_reason->translate($localeCode)->text ?? ""}}
                          </textarea>

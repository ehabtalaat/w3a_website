...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit consultation')}}</h3>
		</div>
	</div>
    ...
    <div class="row">
        ...
        <img src="{{$consultation->image->image_link}}">
        @endif
        </div>
              </div>
...
<div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$consultation->translate($localeCode)->title ?? ""}}"
                           required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                        <label>{{__('messages.from_price')}}</label>
                        <input type="number" class="form-control @error('from_price') is-invalid @enderror" 
                        name="from_price" min="0"
                        value="{{$consultation->from_price}}" required/>
                         @error('from_price') <span class="invalid-feedback">
                             {{ $message }}</span> @enderror
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                        <label>{{__('messages.to_price')}}</label>
                        <input type="number" class="form-control @error('to_price') is-invalid @enderror" 
                        name="to_price" min="0"
                        value="{{$consultation->to_price}}"  required/>
                         @error('to_price') <span class="invalid-feedback">
                             {{ $message }}</span> @enderror
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}" rows="7"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" required>{{$consultation->translate($localeCode)->text ?? ""}}
                          </textarea>

<a href="{{route('book_types.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                         ...
                         {{-- @if(auth()->id() != $id) --}}
                            <div style="cursor:pointer;" onclick="deletebook_types({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">

    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label"> {{__('messages.add book')}}</h3>
            </div>
        </div>
      ...
      @enderror" required value="{{ old('title-' . $localeCode)}}" name="title-{{ $localeCode }}">
                ...
                {{ $message }}</span> @enderror
                  ...
                  @error('type') is-invalid @enderror"  id="type"
                                    ...
                                    <option value="1" >{{__("messages.pdf")}}</option>
                                    <option value="2" >{{__("messages.paper")}}</option>
                                    <option value="3" >{{__("messages.pdf_and_paper")}}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          @enderror" required name="mini_text-{{ $localeCode }}" rows="4"></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          @enderror" required name="text-{{ $localeCode }}" rows="8"></textarea>

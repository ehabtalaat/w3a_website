...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit payment_method')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('payment_methods.update',$payment_method->id)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <img src="{{$payment_method->image->image_link}}">
        @endif
        </div>
              </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$payment_method->translate($localeCode)->title ?? ""}}"
                           required>
...
<label>
    <input type="checkbox" name="image_required"  value="1" @checked($payment_method->code_required == 1)>
    <span ></span>
...
<span class="switch btn btns-m switch-outline switch-icon switch-primary">
<label>
    <input type="checkbox" name="code_required"  value="1" @checked($payment_method->code_required == 1)>
    <span ></span>
...
<div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          <textarea rows="7" class="form-control  @error('text-' . $localeCode) is-invalid @enderror"
                          name="text-{{ $localeCode }}"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" required>{{$payment_method->translate($localeCode)->text ?? ""}}
                          </textarea>

...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.edit blog')}}</h3>
		</div>
	</div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$blog->translate($localeCode)->title ?? ""}}"
                           required>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" required>{{$blog->translate($localeCode)->text ?? ""}}
                          </textarea>

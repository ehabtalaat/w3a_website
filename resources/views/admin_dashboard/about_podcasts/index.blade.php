...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
    <form method="post" action="{{route('about_podcasts.update')}}" enctype="multipart/form-data">
        @method('PUT')
    @csrf
    <div class="row">
        ...
        @if($about_podcast->image)
        <img src="{{$about_podcast->image->image_link}}">
        @endif
        </div>
              </div>
        ...
        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          @enderror" 
                          required value="{{ $about_podcast->translate($localeCode)->title ?? ''}}"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        name="text-{{ $localeCode }}"
                         placeholder="{{ __('messages.text_'.$localeCode) }}" rows="7" required>{{ $about_podcast->translate($localeCode)->text ?? ""}}</textarea>

  ...
  <div class="card card-custom gutter-b">
    ...
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label"> {{__('messages.edit course')}}</h3>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-6 mx-auto">
            <div class="uploadOuter">
              ...
              @if($course->image)
              <img src="{{$course->image->image_link}}">
              @endif
              </div>
          </div>
        <div class="col-md-6 col-12 mx-auto text-center mb-5 set-img mx-auto">
                    <video width="200" height="200" controls >
              <source src="{{ $course->video_link ?? ''}}" id="video_here">
...
@enderror" required value="{{ $course->translate($localeCode)->title}}" name="title-{{ $localeCode }}">
          ...
          <div class="col-md-6 col-sm-12">
            <div class="form-group">
              ...
              <textarea class="form-control  summernote @error('features-' . $localeCode) is-invalid 
                          @enderror" required name="features-{{ $localeCode }}" rows="6">{{$course->translate($localeCode)->features ?? ''}}
              </textarea>

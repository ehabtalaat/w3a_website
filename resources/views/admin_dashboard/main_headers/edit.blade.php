                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="title-{{ $localeCode }}"
                           ...
                           value="{{$main_header->translate($localeCode)->title ?? ""}}"
                           required>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          name="text-{{ $localeCode }}"
                           placeholder="{{ __('messages.text_'.$localeCode) }}" rows="7" required>{{$main_header->translate($localeCode)->text ?? ""}}
                          </textarea>

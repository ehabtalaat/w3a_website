              ...
              <div class="col-md-6 col-12 mt-3">
                <div class="form-group">
                    ...
                    data-live-search="true"  title="&nbsp;">
                        ...
                        <option value="{{$country->id}}" @selected($country->id == $pharmacy->country_id)>{{$country->title}}</option>
                         @endforeach
                    </select>
            ...
            <div class="col-md-6 col-12 mt-3">
                <div class="form-group">
                    ...
                    data-live-search="true"  title="&nbsp;">
                        ...
                        <option value="{{$state->id}}" @selected($state->id == $pharmacy->state_id)>{{$state->title}}</option>
                         @endforeach
                    </select>
            ...
            <div class="col-md-6 col-12 mt-3">
                <div class="form-group">
                    ...
                    data-live-search="true"  title="&nbsp;">
                        ...
                        <option value="{{$city->id}}" @selected($city->id == $pharmacy->city_id)>{{$city->title}}</option>
                         @endforeach
                    </select>
              ...
              <div class="row mt-4">
                <div id="map" style="width:100%;height:400px; ">
                 ...
                 <input type="hidden" class="form-control " value="{{$pharmacy->lat}}" id="Lat" name="lat" />
              
       
                 <input type="hidden" class="form-control " value="{{$pharmacy->lon}}"  id="Lng" name="lon" />
            ...
            <div class="col-md-4 col-12 mt-3">
                <div class="form-group"> 
                    ...
                    data-live-search="true"  title="&nbsp;">
                        ...
                        <option value="{{$payment_method->id}}" @selected(in_array($payment_method->id,$pharmacy->payment_methods->pluck("id")->toArray()))>{{$payment_method->title}}</option>
                         @endforeach
                    </select>
            ...
            <div class="col-md-4 col-12 mt-3">
                <div class="form-group">
                    ...
                    <input class="form-control custom_input @error('price') is-invalid @enderror"  type="number" 
                     name="price"    value="{{ $pharmacy->price}}"
            ...
            <div class="col-md-4 col-12 mt-3">
                <div class="form-group">
                    ...
                    data-live-search="true"  title="&nbsp;">
                        ...
                        <option value="0" @selected($pharmacy->status == 0)>{{__('messages.done')}}</option>
                        <option value="1" @selected($pharmacy->status == 1)>{{__('messages.there_is_problem')}}</option>
                        <option value="2" @selected($pharmacy->status == 2)>{{__('messages.not_pay')}}</option>
                    </select>

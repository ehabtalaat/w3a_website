...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label"> {{__('messages.certificate')}}</h3>
		</div>
	</div>
 
 
    <div class="card-body">
    <form method="post" action="{{route('certificates.update')}}" enctype="multipart/form-data">
        @method('PUT')
    @csrf
    <div class="row">
        ...
        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="form-group">
                          ...
                          @enderror" 
                          required value="{{ $certificate->translate($localeCode)->title ?? ''}}"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea  class="form-control summernote @error('text-' . $localeCode) is-invalid @enderror"
                        name="text-{{ $localeCode }}"
                         placeholder="{{ __('messages.text_'.$localeCode) }}" rows="7" required>{{ $certificate->translate($localeCode)->text ?? ""}}</textarea>
